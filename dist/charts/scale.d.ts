 ...
 * @see ../../doc_md/reference/visuals.md
 */
export declare const EIGHTHS: readonly string[];
/**
 ...
 * @see ../../doc_md/reference/visuals.md
 */
export declare const SHADES: readonly string[];
/**
 ...
 * @see ../../doc_md/reference/visuals.md
 */
export declare const BRAILLE: readonly string[];
/**
 ...
 * @see ../../doc_md/reference/visuals.md
 */
export declare function absoluteIndex(percent: number, steps: number): number;
/**
 ...
 * @see ../../doc_md/reference/visuals.md
 */
export declare function relativeIndex(value: number, min: number, max: number, steps: number): number;
/**
 ...
 * @see ../../doc_md/reference/status-checklists-skill.md
 */
export declare function boundaryGlyph(fraction: number): string;
/**
 ...
 * @see ../../doc_md/reference/status-checklists-skill.md
 */
export declare function barCells(percent: number, cells?: number): string;
