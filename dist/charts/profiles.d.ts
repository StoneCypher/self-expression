 ...
 */
export declare const CHECKLIST_PROFILE: DigestProfile;
/**
 ...
 */
export declare const FINDINGS_PROFILE: DigestProfile;
/**
 ...
 *   // => '1/2/3 options  ❌ 3  🤔 2  ✅ 1'
 */
export declare const OPTIONS_PROFILE: DigestProfile;
/**
 ...
 */
export declare const DIFF_PROFILE: DigestProfile;
/**
 ...
 *   // => '14/2/1 hits  🔍 14  🌗 2  🦗 1'
 */
export declare const RESULTS_PROFILE: DigestProfile;
/**
 ...
 */
export declare const PROFILE_NAMES: readonly ["checklist", "findings", "options", "diff", "results"];
 ...
 */
export declare const PROFILES: Readonly<Record<ProfileName, DigestProfile>>;
/**
 ...
 */
export declare function profileForNoun(noun: string): DigestProfile | undefined;
