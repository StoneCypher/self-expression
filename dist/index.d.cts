 ...
 * @see ./layout.js
 */
declare const MATRIX_FALLBACKS: string;
/**
 ...
 * @see requireGridSafe
 */
declare function normalizeMatrix(rows: readonly string[], cols: readonly string[], values: readonly (readonly number[])[]): MatrixData;
/**
 ...
 * @see renderMatrix
 */
declare function matrixTotals(data: MatrixData): MatrixTotals;
/**
 ...
 * @see seriate
 */
declare function seriationScore(data: MatrixData): number;
/**
 ...
 * @see renderMatrix
 */
declare function seriate(data: MatrixData, options?: SeriationOptions): SeriationResult;
/**
 ...
 * @see seriate
 */
declare function describeSeriation(result: SeriationResult): string;
 ...
 * @see renderMatrix
 */
declare const MATRIX_RAMP: readonly string[];
/**
 ...
 * @see renderTree
 */
declare function renderMatrix(data: MatrixData, options?: MatrixRenderOptions): string;
