# react_ts_with_claude_gh_template v0.23.0

> Version 0.23.0 was built on Saturday, July 18, 2026 at GMT-07:00 `1784379808782` from hash `e163bbd`.

TODO Put the project description here, please.

<!-- Supported embeds: 1784379808782 Saturday, July 18, 2026 at GMT-07:00 66.66 2 50 e163bbd {{stochbranch}} 66.66 {{stochfunc}} {{stochline}} 4 47 {{unitbranch}} {{unitfunc}} {{unitline}} 43 0.23.0 -->
...
1. [ ] Apply branch protection — the ruleset ships in `.github/ruleset.json` (requires the fixed-name `gate` check; no reviews; blocks force-push and deletion; admin bypass) but rulesets are repo settings and do not copy with the template:
